...
const Settings = () => {
  ...
  const handleUpdate = (values) => {
    ...
    dispatch(updateProfileName(values.name));
    dispatch(updateProfileProfession(values.profession));
    dispatch(updateProfileUsername(values.username)); 
    message.success("Settings updated successfully!");
    form.resetFields();
  };
      ...
      <div className="p-0" style={layoutStyles}>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={12}>
            <Card
              title="Personal Information"
              className="w-full rounded-lg shadow-lg p-4 md:w-[400px] lg:w-[400px] xl:w-[588px]"
  ...
  >
    Cancel
          ...
          <Col xs={24} md={12}>
            <Card
              title="Your Photo"
              className="w-full rounded-lg shadow-lg p-2 text-left md:w-[250px] lg:w-[256px] xl:w-[348px] md:ml-[111px]"
       ...
       <div
          ...
          className="relative mb-5.5 block w-full max-w-xs h-48 flex flex-col items-center justify-center cursor-pointer appearance-none rounded border border-2 border-blue-500 border-dashed p-4 bg-gray dark:bg-meta-4 md:w-[204px] lg:w-[204px] xl:w-[289px] sm:[289px]"
...
<button
          className="flex justify-center rounded bg-primary px-6 py-2 font-medium hover:bg-opacity-90"
