...
//       <div className="bg-white shadow-lg rounded-lg w-full lg:w-2/3 p-6 min-h-[400px]">
...
//       <div className="bg-white shadow-none rounded-lg w-full lg:w-1/3 p-6 min-h-[400px]">
